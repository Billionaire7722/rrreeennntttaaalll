...
export default function HelpSupport() {
    ...
    const faqs = [
        { q: t("faq_q1") || "How do I post a property?", a: t("faq_a1") || "You can post a property by clicking the plus (+) icon on the home screen or within your profile management area." },
        { q: "How do I change my account details?", a: "Go to your Profile, open the Settings drawer, and select 'Accounts Center' to update your information or password." },
        { q: "Is my data secure?", a: "Yes, we use industry-standard encryption and security protocols to ensure your personal data and listing information are kept private." },
        { q: "How do I contact a landlord?", a: "Once you find a property you like, click 'Contact Now' to start a direct chat with the landlord or agent." },
    ];
            ...
            <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12 space-y-12">
                ...
                <section className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 p-8 sm:p-12 text-center">
                    ...
                    <div className="relative z-10 space-y-6">
                        ...
                        <h2 className="text-3xl sm:text-4xl font-black text-white tracking-tight">{t("help_subtitle") || "How can we help?"}</h2>
                ...
                <section className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <ContactCard 
                        ...
                        title={t("contact_email") || "Email Support"}
                        desc="support@yourhome.com"
                        color="bg-blue-50 text-blue-600"
                    />
                    <ContactCard 
                        icon={<MessageCircle className="w-6 h-6" />}
                        title={t("contact_chat") || "Live Chat"}
                        desc="Average response: 5m"
                        color="bg-teal-50 text-teal-600"
                    />
                    <ContactCard 
                        icon={<Phone className="w-6 h-6" />}
                        title={t("contact_call") || "Call Support"}
                        desc="+1 (555) 000-0000"
                ...
                <section className="space-y-8">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-2xl font-black text-slate-900 tracking-tight">{t("faq_title") || "Frequently Asked Questions"}</h3>
                    </div>
                ...
                <section className="bg-slate-50 border-2 border-dashed border-slate-200 rounded-[2.5rem] p-8 text-center">
                    <p className="text-slate-500 font-bold mb-4">Still need help? Our team is available 24/7.</p>
                    <button className="px-8 h-12 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 active:scale-95 transition-all">
                        Open Support Ticket
                    </button>
                </section>
            </main>
